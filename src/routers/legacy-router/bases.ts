...
export const BASES_TO_CHECK_TRADES_AGAINST = (
  ...
  return {
    ...
    [ChainId.CANXIUM]: [WRAPPED_NATIVE_CURRENCY[ChainId.CANXIUM]!, USDC_CANXIUM],
    [ChainId.CANXIUM_CERIUM]: [WRAPPED_NATIVE_CURRENCY[ChainId.CANXIUM_CERIUM]!, USDC_CANXIUM_CERIUM],
  };
};
